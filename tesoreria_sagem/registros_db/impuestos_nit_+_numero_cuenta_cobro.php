		...
		<?php include('_menu.php');?>
			...
			<div class="col-md-9">
			  	<div class="content-box-large" style="text-align: center;">
					...
					<div>
							<h5><b><font color = "#2F62B0"> REPORTE DE IMPUESTOS A PROVEEDORES POR NIT Y NUMERO DE CUENTA DE COBRO </font></h5>
					</div>			
<!--sublime-->
					<hr>
					<?php
					...
					*/
					...
					<div class="content-box-short">
						...
						<form name = "form_Num_Procesos" method = "post" action = "descargar_impuestos_nit_+_numero_cuenta_cobro.php">
							<table  class="w3-table-all w3-card-4">
									...
									<tr>
										...
										<td><input type = "text" name = "txtcta" placeholder = "Cuenta de Cobro" required maxlength="20" pattern="[0-9]+" ></td>
									</tr>
									<!--
									<tr>
									...
									<tr>
										...
										<td><input type = "text" name = "txtdocto" placeholder = "Documento Pago" maxlength="12" ></td>
									</tr>
