		...
		<?php include('_menu.php');?>
			<div class="col-md-9">
			  	<div class="content-box-large" style="text-align: center;">
					...
					<div>
							<h5><b><font color = "#2F62B0"> REPORTE DE IMPUESTOS A PROVEEDORES POR LISTA DE RADICADOS </font></h5>
					</div>			
<!--sublime-->
					<hr>
					<?php
					...
					*/
					...
					<div class="content-box-short">
						...
						<form name = "form_Num_Procesos" method = "post" action = "descargar_impuestos_lista_radicados.php">
	...
	<script type="text/javascript">
		...
		function get_lista_radicados() {
			  ...
			  if(rad.value !== ''){
				window.location.href = "descargar_tesoreria_lista_radicados.php?txtidrad="+rad.value;
				rad.value="";
			  }
		}
