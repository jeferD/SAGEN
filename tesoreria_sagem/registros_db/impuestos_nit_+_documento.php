		...
		<?php include('_menu.php');?>
			...
			<div class="col-md-9">
			  	<div class="content-box-large" style="text-align: center;">
					...
					<div>
							<h5><b><font color = "#2F62B0"> REPORTE DE IMPUESTOS A PROVEEDORES POR NIT Y NUMERO DE DOCUMENTO DE PAGO</font></h5>
					</div>			
<!--sublime-->
					<hr>
					<?php
					...
					*/
					...
					<div class="content-box-short">
						...
						<form name = "form_Num_Procesos" method = "post" action = "descargar_impuestos_nit_+_documento.php">
							<table  class="w3-table-all w3-card-4">
									...
									-->
									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">Documento Impuesto</font></th>
										<td><input type = "text" name = "txtdocto" required placeholder = "Documento Impuesto" maxlength="12" ></td>
									</tr>
									<!--
									<tr>
