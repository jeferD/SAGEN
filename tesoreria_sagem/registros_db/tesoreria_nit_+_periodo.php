		...
		<?php include('_menu.php');?>
			...
			<div class="col-md-9">
			  	<div class="content-box-large" style="text-align: center;">
					...
					<div>
							<h5><b><font color = "#2F62B0"> REPORTE DE PAGOS A PROVEEDORES POR NIT Y PERIODO </font></h5>
					</div>			
<!--sublime-->
					<hr>
					<?php
					...
					*/
					...
					<div class="content-box-short">
						...
						<form name = "form_Num_Procesos" method = "post" action = "descargar_tesoreria_nit_+_periodo.php">
