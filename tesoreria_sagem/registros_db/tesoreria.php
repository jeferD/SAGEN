		...
		<?php include('_menu.php');?>
			...
			<div class="col-md-9">
			  	<div class="content-box-large" style="text-align: center;">
					...
					<div>
							<h5><b><font color = "#2F62B0"> REPORTE DE PAGOS POR FACTURA - CORTE 2021-08-31</font></h5>
					</div>			
<!--sublime-->
					<hr>
					<?php
					...
					*/
					...
					<div class="content-box-short">
						...
						<form name = "form_Num_Procesos" method = "post" action = https://servicios.emssanar.org.co/tesoreria_sagem/registros_db/descargar_tesoreria.php>
