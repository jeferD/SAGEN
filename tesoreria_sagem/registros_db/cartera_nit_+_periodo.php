		...
		<?php include('_menu.php');?>
			...
			<div class="col-md-9">
			  	<div class="content-box-large" style="text-align: center;">
					...
					<div>
							<h5><b><font color = "#2F62B0"> REPORTE DE CARTERA A PROVEEDORES POR NIT Y PERIODO </font></h5>
					</div>
<!--sublime-->
					<hr>
					<?php 
					...
					<div class="content-box-short">
						...
						<!--<form name = "form_Num_Procesos" method = "post" action = "descargar_cartera_nit_+_periodo.php">-->
						<form name = "form_Num_Procesos" method = "post" action = "descargar_cartera_nit_+_periodo.php">
							<table  class="w3-table-all w3-card-4">
									...
									-->
									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">Periodo de radicacion inicial</font></th>
										<td><input type = "date" name = "txtfini" ></td></tr>
									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">Periodo de radicacion final</font></th>
