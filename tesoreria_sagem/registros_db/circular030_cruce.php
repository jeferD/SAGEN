...
ini_set("display_errors", "on");
	...
	/*
	function crearCruce($nit,$ctacobro,$idrad,$docto,$fini,$ffin)
		{
			...
			$consulta="SELECT * FROM tesoreria_sac.consulta_cruce('".$nit."',".$ctacobro.",".$idrad.",".$docto.",".$fini.",".$ffin.");";
		...
		<?php include('_menu.php');?>
			...
			<div class="col-md-9">
			  	<div class="content-box-large" style="text-align: center;">
					...
					<div>
							<h5><b><font color = "#2F62B0"> REPORTE CIRCULAR 030 CRUCE - CORTE 2021-06-30</font></h5>
					</div>
...
<!--sublime-->
					...
					<?php
					/*
						if(array_key_exists('txtnit', $_POST)&& array_key_exists('cruce', $_POST)){

										$conexion = conectar_PostgreSQL( "postgres", "123456", "192.168.125.18", "5432", "sagem" );
										$consulta=crearCruce($_POST['txtnit'],$_POST['txtctacobro'],$_POST['txtidrad'],$_POST['txtdocto'],$_POST['fini'],$_POST['ffin']);

										$res=ejecutarProcedure( $conexion, $consulta );
										//echo $consulta;
										$nit=$_POST['txtnit'];

										echo'<script type="text/javascript">window.location="Descargas/'.$nit.'.csv"</script>';
					...
					*/	
					...
					<div class="content-box-short">
						...
						<form name = "form_Num_Procesos" method = "post" action = "descargar_cruce.php">
							<table  class="w3-table-all w3-card-4">


									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">NIT*</font></th>
										<td width=40%><input type="number" name = "txtnit" placeholder = "NIT Prestador"required pattern="[0-9]+" ></td>
									</tr>
									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">Cuenta de Cobro</font></th>
										<td><input type = "text" name = "txtctacobro" placeholder = "Cuenta de Cobro" maxlength="20" pattern="[0-9]+" readonly></td>
									</tr>
									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">Radicado</font></th>
										<td><input type = "text" name = "txtidrad" placeholder = "Radicado" maxlength="10" pattern="[0-9]+" readonly></td>
									</tr>
									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">Documento Pago</font></th>
										<td><input type = "text" name = "txtdocto" placeholder = "Documento Pago" maxlength="12" readonly></td>
									</tr>
									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">Fecha Radicacion inicial</font></th>
										<td><input type = "date" name = "fini" readonly></td></tr>
									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">Fecha Radicacion Final</font></th>
										<td><input type = "date" name = "ffin" readonly></td>
									</tr>		
							</table><br>
								<input class = "w3-button w3-blue" name = "cruce" type = "submit" value = "DESCARGAR CRUCE" title="DESCARGA ARCHIVO DE FACTURAS DE CIRCULAR 030 REPORTADAS POR LA EPS vs IPS">
						</form><br>
					</div>
				</div>
			</div>
