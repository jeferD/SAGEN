...
ini_set("display_errors", "on");
	...
	/*
	function crearFepa($nit,$ctacobro,$idrad,$docto,$fini,$ffin)
	{
		...
		$consulta="SELECT * FROM tesoreria_sac.consulta_fepa('".$nit."',".$ctacobro.",".$idrad.",".$docto.",".$fini.",".$ffin.");";
		...
		<?php include('_menu.php');?>
			...
			<div class="col-md-9">
			  	<div class="content-box-large" style="text-align: center;">
					...
					<div>
							<h5><b><font color = "#2F62B0"> REPORTE CIRCULAR 030 FEPA - CORTE 2021-06-30</font></h5>
					</div>
...
<!--sublime-->
					...
					<?php
						...
						if(array_key_exists('txtnit', $_POST)&& array_key_exists('fepa', $_POST)){

							$conexion = conectar_PostgreSQL( "postgres", "123456", "192.168.125.18", "5432", "sagem" );
							$consulta=crearFepa($_POST['txtnit'],$_POST['txtctacobro'],$_POST['txtidrad'],$_POST['txtdocto'],$_POST['fini'],$_POST['ffin']);
					...
					<div class="content-box-short">
						...
						<form name = "form_Num_Procesos" method = "post" action = "descargar_fepa.php">
							<table  class="w3-table-all w3-card-4">
								...
								<input class = "w3-button w3-blue" name = "fepa" type = "submit" value = "DESCARGAR FEPA" title="DESCARGA ARCHIVO DE FACTURAS DE CIRCULAR 030 REPORTADAS POR LA EPS">
						</form><br>
					</div>
				</div>
			</div>
