		...
		<?php include('_menu.php');?>
			...
			<div class="col-md-9">
			  	<div class="content-box-large" style="text-align: center;">
					...
					<div>
							<h5><b><font color = "#2F62B0"> REPORTE DE CARTERA A PROVEEDORES POR NIT Y NUMERO DE CUENTA DE COBRO  </font></h5>
					</div>
<!--sublime-->
					<hr>
					<?php 
					...
					<div class="content-box-short">
						...
						<!--<form name = "form_Num_Procesos" method = "post" action = https://servicios.emssanar.org.co/tesoreria_sagem/registros_db/descargar_cartera.php>-->
						<form name = "form_Num_Procesos" method = "post" action = "descargar_cartera_nit_+_numero_cuenta_cobro.php">
							<table  class="w3-table-all w3-card-4">
									...
									<tr>
										<th bgcolor= "white"><font color = "#2F62B0">Numero de cuenta de cobro</font></th>
										<td><input type = "text" name = "txtcta" required pattern="[0-9]+" placeholder = "Cuenta de Cobro" maxlength="20" pattern="[0-9]+" ></td>
									</tr>
									<!--
									<tr>
