...
function crearPagos_Radicados($numeros_de_radicados)
	{
		$consulta="SELECT * FROM tesoreria_global.exportar_impuestos_lista_de_radicados('{".$numeros_de_radicados."}');";
		return $consulta;
}
...
$consulta=crearPagos_Radicados($numeros_de_radicados);	
...
$fieldname = date("Y-m-d")."_IMPUESTOS_POR_RADICADOS";
