...
function crearCartera($nit,$fini,$ffin)
	{
		...
		$consulta="SELECT * FROM tesoreria_global.exportar_cartera_nit_periodo('".$nit."',".$fini.",".$ffin.");";
...
$consulta=crearCartera($_POST['txtnit'],$_POST['txtfini'],$_POST['txtffin']);	
...
if($fini == NULL OR $fini== '' OR $ffin == NULL OR $ffin == ''){
	...
	$fieldname = date("Y-m-d")."_CARTERA_NIT_".$nit."_PERIODO_ENTRE_".$fini."_A_".$ffin;
